...
exports.handler = async (event) => {
    ...
    if (event.resource === '/signup' && event.httpMethod === 'POST') {
        ...
        try {
            ...
            return apiResponse(200, { message: "User created successfully" }, { "Content-Type": "application/json", })
        } catch (error) {
            console.log(error);
    ...
    if (event.resource === '/signin' && event.httpMethod === 'POST') {
        ...
        try {
            ...
            console.log(data);
            return apiResponse(200, { accessToken: data.AuthenticationResult.IdToken || 'blank' }, { "Content-Type": "application/json", })
